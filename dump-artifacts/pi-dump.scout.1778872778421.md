<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: scout | Tier: lite | Pipeline: 1.8.40 | Generated: 2026-05-15T19:19:38.421Z -->
...
<activation flow="scout" depth="2" tools="batch, bash, flow, web" tier="lite">
