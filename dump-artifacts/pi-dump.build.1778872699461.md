<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: build | Tier: undefined | Pipeline: 1.8.40 | Generated: 2026-05-15T19:18:19.461Z -->
...
<activation flow="build" depth="1" tools="batch, bash, flow, web" tier="undefined">
