<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: build | Generated: 2026-05-15T15:43:11.990Z -->
...
<activation flow="build" depth="1" tools="read, write, edit, batch, bash, flow, web">
