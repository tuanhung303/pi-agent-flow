<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: scout | Tier: undefined | Pipeline: 1.8.40 | Generated: 2026-05-15T19:05:48.975Z -->
...
You are a [scout] agent operating at depth 3.
Available tools: read, write, edit, batch, bash, flow, web.
You may NOT delegate to sub-flows (depth 3/3 | cycles: blocked | stack: orchestrator -> scout).
