<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: build | Generated: 2026-05-15T15:48:59.883Z -->
...
<activation flow="build" depth="3" tools="batch, bash, web">
