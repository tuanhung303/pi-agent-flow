<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: build | Tier: flash | Pipeline: 1.8.40 | Generated: 2026-05-16T00:11:46.421Z -->
...
<activation flow="build" depth="3" tools="batch, bash, web" tier="flash">
