<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: scout | Tier: undefined | Pipeline: 1.8.40 | Generated: 2026-05-15T19:10:09.778Z -->
...
<activation flow="scout" depth="1" tools="read, write, edit, batch, bash, flow, web" tier="undefined">
You are a [scout] agent operating at depth 1.
Available tools: read, write, edit, batch, bash, flow, web.
