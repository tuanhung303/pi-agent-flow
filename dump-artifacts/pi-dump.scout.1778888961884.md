<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: scout | Tier: lite | Pipeline: 1.8.40 | Generated: 2026-05-15T23:49:21.884Z -->
...
<activation flow="scout" depth="3" tools="batch, bash, web" tier="lite">
