<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: scout | Generated: 2026-05-15T15:49:00.001Z -->
...
<activation flow="scout" depth="3" tools="read, write, edit, batch, bash, flow, web">
