<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: build | Tier: flash | Pipeline: 1.8.40 | Generated: 2026-05-15T19:20:28.807Z -->
...
<activation flow="build" depth="1" tools="bash, flow, batch" tier="flash">
