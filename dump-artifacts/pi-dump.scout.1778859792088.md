<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: scout | Generated: 2026-05-15T15:43:12.088Z -->
...
<activation flow="scout" depth="2" tools="read, write, edit, batch, bash, flow, web">
