<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: scout | Generated: 2026-05-15T15:51:34.518Z -->
...
<activation flow="scout" depth="1" tools="read, write, edit, batch, bash, flow, web">
