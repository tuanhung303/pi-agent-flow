<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: build | Tier: flash | Pipeline: 1.8.40 | Generated: 2026-05-16T00:17:00.859Z -->
...
<activation flow="build" depth="1" tools="batch, bash, flow, web" tier="flash">
