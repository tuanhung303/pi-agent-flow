<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: build | Generated: 2026-05-15T15:51:34.480Z -->
...
<activation flow="build" depth="1" tools="batch, bash, flow, web">
