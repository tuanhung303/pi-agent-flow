<!-- pi-agent-flow dump | State: post-sanitization | Passes: sanitizeForkSnapshot (see src/snapshot.ts) | Flow: build | Tier: undefined | Pipeline: 1.8.40 | Generated: 2026-05-15T19:05:06.862Z -->
...
<activation flow="build" depth="1" tools="bash, flow, batch" tier="undefined">
You are a [build] agent operating at depth 1.
Available tools: bash, flow, batch.
